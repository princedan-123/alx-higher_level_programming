#This is an ALX software engineering task on how to integrate Databases with python programs
# Task 0 to task 5 focuses on the use of Mysqldb database connector which provides a low level access
#to databases.
# task 6 to advanced tasks focuses on the use of object relational mappers (ORM). SQLAlchemy was used for the task.
#Below are the task for the project:
Tasks
0. Get all states
mandatory
